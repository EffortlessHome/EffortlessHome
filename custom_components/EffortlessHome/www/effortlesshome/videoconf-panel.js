class VideoConfPanel extends HTMLElement {
  connectedCallback() {
    ...
    this.querySelector("#launch-jitsi").addEventListener("click", () => {
      ...
      const roomName = "EffortlessHome Senior Living Room Demo 1"; // Customize your room name
      const url = `${domain}/${roomName}#userInfo.displayName="EffortlessHome Demo User 1"`;
