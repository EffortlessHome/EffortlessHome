class ExtendedProfile extends HTMLElement {
    ...
    this.innerHTML = `
      ...
      <div class="container">
        ...
        <div class="profile left-column">
          ...
          <p><a href="https://effortlesshome.ai/account/my-effortlesshome/" target="_blank">My Account</a></p>
        </div>
    
        <div class="section left-column">
          <h3>System Users</h3>
          <div class="user-list" id="user-list"></div>
          <p><a href="https://effortlesshome.ai/account/my-effortlesshome/" target="_blank">Manage Users</a></p>
        </div>
        ...
        <div class="right-column">
          ...
          <div class="section">
            ...
            <div class="subscription-box" id="subscriptions">
              <a href="https://effortlesshome.ai/account/my-effortlesshome/manage-subscription/" target="_blank">Manage Subscription</a>
            </div>
          </div>
        </div>
      </div>
  ...
  async populateCurrentUser() {
    ...
    userElement.innerHTML = `
      <img src="https://effortlesshome.ai/wp-content/uploads/2025/10/user.png" alt="Profile Picture">
  ...
  async populateUsers() {
    ...
    const hass = document.querySelector("home-assistant")?.hass;
    if (!hass) return alert("EffortlessHome instance not found.");
